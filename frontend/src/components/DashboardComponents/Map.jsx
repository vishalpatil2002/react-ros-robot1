        ...
        >
          ...
          <div
            ...
            style={{
              ...
              // backgroundImage: "linear-gradient(135deg, #ece1d6 0%, #e7dad0 100%)",
              borderRadius:"5px"
            }}
          >
            {/* Zoom in button */}
            <button id="zoomin" style={{ width: "80px",borderRadius:"5px" }}>
              <img
                src={image}
            ...
            {/* Zoom out button */}
            <button id="zoomout" style={{ width: "80px", borderRadius:"5px" }}>
              <img
                src={zoomout}
                className="icn2 menuicn"
                id="playmission"
            ...
            {/* Fit button */}
            <button id="fit" style={{ width: "80px", borderRadius:"5px" }}>
              <svg
